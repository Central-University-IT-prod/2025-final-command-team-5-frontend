...
const UserControl = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await axios.get(
        'https://prod-team-5-qnkvbg7c.REDACTED/api/user/all',
        {
          headers: {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const token = localStorage.getItem('userToken');
      await axios.put(
        `https://prod-team-5-qnkvbg7c.REDACTED/api/user/edit/${editingUser.id}`,
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleCreateSubmit = async (e) => {
    ...
    try {
      ...
      const token = localStorage.getItem('userToken');
      await axios.post(
        'https://prod-team-5-qnkvbg7c.REDACTED/api/user/sign-up',
        createFormData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const verifyUser = async (userId) => {
    try {
      const token = localStorage.getItem('userToken');
      await axios.post(
          `https://prod-team-5-qnkvbg7c.REDACTED/api/user/verify/${userId}`,
          { verified: true },
          {
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const handleDeleteSubmit = async () => {
    try {
      ...
      const token = localStorage.getItem('userToken');
      await axios.delete(
        `https://prod-team-5-qnkvbg7c.REDACTED/api/user/delete/${deletingUser.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/json',
  ...
  const handleBlockUser = async (userId) => {
    try {
      const token = localStorage.getItem('userToken');
      await axios.post(
        `https://prod-team-5-qnkvbg7c.REDACTED/api/user/block/${userId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleUnblockUser = async (userId) => {
    try {
      const token = localStorage.getItem('userToken');
      await axios.post(
        `https://prod-team-5-qnkvbg7c.REDACTED/api/user/unblock/${userId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
